CreateGUITextByLanguage(Language, localVersion) {
    ...
    if (Language = 1) {
        ...
        Lang["Txt_Buzzwole"] := "Buzzwole (disabled)"
        Lang["Txt_Solgaleo"] := "Solgaleo (disabled)"
        Lang["Txt_Lunala"] := "Lunala (disabled)"
        ...
        Lang["Txt_Lugia"] := "洛奇亞"
        Lang["Txt_Eevee"] := "伊布"
        Lang["Txt_Buzzwole"] := "爆肌蚊 (disabled)"
        Lang["Txt_Solgaleo"] := "索爾迦雷歐 (disabled)"
        Lang["Txt_Lunala"] := "露奈雅拉 (disabled)"
        ...
        Lang["Txt_Lugia"] := "ルギア"
        Lang["Txt_Eevee"] := "イーブイ"
        Lang["Txt_Buzzwole"] := "マッシブーン (disabled)"
        Lang["Txt_Solgaleo"] := "ソルガレオ (disabled)"
        Lang["Txt_Lunala"] := "ルナアーラ (disabled)"
        ...
        Lang["Txt_Buzzwole"] := "Masskito (disabled)"
        Lang["Txt_Solgaleo"] := "Solgaleo (disabled)"
        Lang["Txt_Lunala"] := "Lunala (disabled)"
